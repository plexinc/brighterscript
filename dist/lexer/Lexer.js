...
class Lexer {
    ...
    replacementIdentifier() {
        ...
        if (depth > 0) {
            this.diagnostics.push(Object.assign(Object.assign({}, DiagnosticMessages_1.DiagnosticMessages.unterminatedReplacementIdentifier()), { range: this.rangeOf() }));
        }
        else {
            this.addToken(TokenKind_1.TokenKind.ReplacementIdentifier);
        }
    }
    templateQuasiString() {
...
Lexer.tokenFunctionMap = {
    ...
    '@': function () {
        if (this.peek() === '.') {
            ...
            this.advance();
            this.advance();
            this.addToken(TokenKind_1.TokenKind.AtStop);
        }
        else {
