...
export declare class Scope {
    ...
    getTypeStatement(typeName: string, containingNamespace?: string): Statement;
    /**
     ...
     */
    getTypeStatementFileLink(typeName: string, containingNamespace?: string): FileLink<TypeStatement>;
    /**
    ...
    hasTypeStatementType(typeName: string, namespaceName?: string): boolean;
    /**
     ...
     * The key is stored in lower case
     */
    getTypeStatementMap(): Map<string, FileLink<TypeStatement>>;
    /**
