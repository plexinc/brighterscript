...
class TypeStatement extends AstNode_1.Statement {
    constructor(options) {
        ...
        this.range = util_1.util.createBoundingRange(this.tokens.type, this.tokens.name, this.tokens.equals, this.tokens.value);
    }
    transpile(state) {
        return [];
    }
