...
describe('DefinitionProvider', () => {
    ...
    it('handles import statements with src;dest remapped paths', () => {
        ...
        program.setFile({
            src: (0, util_1.standardizePath) `${testHelpers_spec_1.tempDir}/flavor1/flavorSource/utils.brs`,
        ...
        const utils2 = program.setFile({
            src: (0, util_1.standardizePath) `${testHelpers_spec_1.tempDir}/flavor2/flavorSource/sub/utils2.brs`,
        ...
        const main = program.setFile({
            src: (0, util_1.standardizePath) `${testHelpers_spec_1.tempDir}/mainApp/src/source1/main.brs`,
        ...
        //main.brs
        // import "u|tils.brs"
        (0, chai_config_spec_1.expect)(program.getDefinition(main.srcPath, util_1.util.createPosition(1, 21))).to.eql([{
                uri: vscode_uri_1.URI.file((0, util_1.standardizePath) `${testHelpers_spec_1.tempDir}/flavor1/flavorSource/utils.brs`).toString(),
                range: util_1.util.createRange(1, 0, 1, 0)
            }]);
        //main.brs
        // import "pkg:/subfolder/ut|ils2.brs"
        (0, chai_config_spec_1.expect)(program.getDefinition(main.srcPath, util_1.util.createPosition(2, 44))).to.eql([{
                uri: vscode_uri_1.URI.file((0, util_1.standardizePath) `${testHelpers_spec_1.tempDir}/flavor2/flavorSource/sub/utils2.brs`).toString(),
                range: util_1.util.createRange(1, 0, 1, 0)
            }]);
        //utils2.brs
        // import "../u|tils.brs"
        (0, chai_config_spec_1.expect)(program.getDefinition(utils2.srcPath, util_1.util.createPosition(1, 21))).to.eql([{
                uri: vscode_uri_1.URI.file((0, util_1.standardizePath) `${testHelpers_spec_1.tempDir}/flavor1/flavorSource/utils.brs`).toString(),
                range: util_1.util.createRange(1, 0, 1, 0)
            }]);
    });
    it('handles import statements', () => {
        ...
        // import "u|tils.brs"
        (0, chai_config_spec_1.expect)(program.getDefinition(main.srcPath, util_1.util.createPosition(1, 21))).to.eql([{
                uri: vscode_uri_1.URI.file(utils.srcPath).toString(),
                range: util_1.util.createRange(1, 0, 1, 0)
            }]);
        // import "pkg:/subfolder/ut|ils2.brs"
        (0, chai_config_spec_1.expect)(program.getDefinition(main.srcPath, util_1.util.createPosition(2, 44))).to.eql([{
                uri: vscode_uri_1.URI.file(utils2.srcPath).toString(),
                range: util_1.util.createRange(1, 0, 1, 0)
            }]);
        // import "../u|tils.brs"
        (0, chai_config_spec_1.expect)(program.getDefinition(utils2.srcPath, util_1.util.createPosition(1, 21))).to.eql([{
