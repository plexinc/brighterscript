...
class CompletionsProcessor {
    ...
    process() {
        ...
        let scopesForFile = this.event.program.getScopesForFile(this.event.file).sort((0, thenby_1.firstBy)(x => x.name));
        ...
        let allCompletions = util_1.util.flatMap(scopesToProcess.map(scope => {
